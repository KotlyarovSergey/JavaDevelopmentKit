...
public class Task2 {
    public static void main(String[] args) {
        ...
        System.out.println("Longest: " + longestName);

        Set<String> cuttedSet = cut(nameSet);
        System.out.println("Cutted 'A': " + cuttedSet);
    }

    private static Set<String> cut(Set<String> nameSet) {
        // return nameSet.stream().filter(s ->
        // !s.toLowerCase().contains("а")).collect(Collectors.toSet());
